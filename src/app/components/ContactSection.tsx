...
export default function ContactSection() {
  return (
    <section id="contact" className="mt-20 relative z-10
      ...
      <h2 className="font-extrabold text-3xl md:text-4xl mb-8 text-center text-[var(--accent)] drop-shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
        <div>
          <h3 className="text-2xl font-semibold text-[var(--text-secondary)] mb-5">Send Me a Message</h3>
          <form
          ...
          >
            <div>
              ...
              <input
                ...
                id="name"
                name="name" 
                className="shadow appearance-none border border-[var(--accent)]/30 rounded-none w-full py-3 px-4 text-[var(--text-primary)] leading-tight
                           focus:outline-none focus:shadow-[0_0_10px_var(--accent)] focus:border-[var(--accent)]
                           bg-[var(--background)]/50 placeholder-slate-400 transition-all duration-300"
            ...
            <div>
              ...
              <textarea
                ...
                className="shadow appearance-none border rounded w-full py-3 px-4 text-gray-700 leading-tight
                           focus:outline-none focus:shadow-outline focus:border-blue-500
                           bg-slate-800/50 border-slate-700 text-slate-100 placeholder-slate-400 resize-y"
            ...
            <button
              ...
              className="inline-flex items-center px-6 py-3 border border-transparent text-base font-semibold shadow-lg
                         text-white bg-gradient-to-r from-[var(--text-secondary)] to-[var(--accent)]
                         hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--accent)]
                         transform transition-all duration-300 w-full justify-center md:w-auto relative overflow-hidden rounded-md"
            >
              Send Message
        ...
        <div className="md:text-left text-center">
          <h3 className="text-2xl font-semibold text-[var(--accent)] mb-5">Connect with Me</h3>
          ...
          <div className="space-y-4">
            <Link
              ...
              className="flex items-center justify-center md:justify-start gap-3 text-white text-lg font-medium
                         hover:text-[var(--accent)] transition-colors duration-200 group"
            >
              <svg className="h-8 w-8 text-[var(--accent)] group-hover:drop-shadow-[0_0_5px_var(--accent)] transition-all" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            ...
            <Link
              ...
              rel="noopener noreferrer"
              className="flex items-center justify-center md:justify-start gap-3 text-white text-lg font-medium
                         hover:text-[var(--text-secondary)] transition-colors duration-200 group"
            >
              <svg className="h-8 w-8 text-[var(--text-secondary)] group-hover:drop-shadow-[0_0_5px_var(--text-secondary)] transition-all" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
