...
export default function Footer() {
  ...
  return (
    <footer className="bg-[var(--background)]/90 backdrop-blur-md border-t border-[var(--accent)] text-[var(--text-primary)] py-8 px-4 text-center relative z-10">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
        ...
        <div className="flex space-x-6">
          <Link
            ...
            className="text-gray-300 hover:text-[var(--text-secondary)] transition-colors text-sm"
          >
            Home
          </Link>
          <Link
        ...
        <div className="flex space-x-4">
          <Link href="https://www.linkedin.com/in/raditya-rakha" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[var(--accent)] transition-colors">
          ...
          <Link href="https://www.instagram.com/rakharenanda/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-[var(--text-secondary)] transition-colors">
